...
v1.0.1
*/
if(!class_exists('pisol_dtt_delivery_date_time_review')){
class pisol_dtt_delivery_date_time_review{
...
new pisol_dtt_delivery_date_time_review('Disable payment method for WooCommerce plugin', 'disable-payment-method-for-woocommerce');
}